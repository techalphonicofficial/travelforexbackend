...
const TripJackCityRegion = require('./models/TripJackCityRegion');

const TripJackConfigService =
  require('./services/TripJackConfigService');

const TripJackClient =
  require('./services/TripJackClient');
...
const TripJackContentService =
  require('./services/tripJackContentService');
...
BlogPost.hasMany(BlogDetail, {
  foreignKey: 'blog_id',
  as: 'details',
  onDelete: 'CASCADE'
});

BlogDetail.belongsTo(BlogPost, {
  foreignKey: 'blog_id',
  as: 'post'
});
...
CustomTrip.hasMany(CustomTripDay, {
  foreignKey: 'custom_trip_id',
  as: 'days',
  onDelete: 'CASCADE'
});

CustomTripDay.belongsTo(CustomTrip, {
  foreignKey: 'custom_trip_id',
  as: 'trip'
});

CustomTripDay.hasMany(CustomTripActivity, {
  foreignKey: 'custom_trip_day_id',
  as: 'activities',
  onDelete: 'CASCADE'
});

CustomTripActivity.belongsTo(CustomTripDay, {
  foreignKey: 'custom_trip_day_id',
  as: 'day'
});

CustomTrip.belongsTo(Customer, {
  foreignKey: 'customer_id',
  as: 'customer'
});

CustomTrip.belongsTo(Destination, {
  foreignKey: 'destination_id',
  as: 'destination'
});

CustomTripDay.belongsTo(Hotel, {
  foreignKey: 'hotel_id',
  as: 'hotel'
});

CustomTripActivity.belongsTo(Activity, {
...
CustomTrip.hasMany(Payment, {
  foreignKey: 'custom_trip_id',
  as: 'payments',
  onDelete: 'CASCADE'
});

Payment.belongsTo(CustomTrip, {
  foreignKey: 'custom_trip_id',
  as: 'custom_trip'
});

TripInquiry.belongsTo(Customer, {
  foreignKey: 'customer_id',
  as: 'customer'
});

Customer.hasMany(TripInquiry, {
  foreignKey: 'customer_id',
  as: 'trip_inquiries'
});

TripInquiry.belongsTo(Destination, {
  foreignKey: 'destination_id',
  as: 'destination_info'
});

Destination.hasMany(TripInquiry, {
  foreignKey: 'destination_id',
  as: 'trip_inquiries'
});
...
HotelBooking.belongsTo(Customer, {
  foreignKey: 'customer_id',
  as: 'customer'
});

Customer.hasMany(HotelBooking, {
  foreignKey: 'customer_id',
  as: 'hotel_bookings'
});
...
Package.belongsToMany(PackageCategory, {
  through: PackageCategoryMapping,
  foreignKey: 'package_id',
  as: 'package_categories'
});

PackageCategory.belongsToMany(Package, {
  through: PackageCategoryMapping,
  foreignKey: 'package_category_id',
  as: 'packages'
});

Package.hasMany(PackageInclusion, {
  foreignKey: 'package_id',
  as: 'inclusions',
  onDelete: 'CASCADE'
});

Package.hasMany(PackageExclusion, {
  foreignKey: 'package_id',
  as: 'exclusions',
  onDelete: 'CASCADE'
});

Package.hasMany(PackageHighlight, {
  foreignKey: 'package_id',
  as: 'highlights',
  onDelete: 'CASCADE'
});

Package.hasMany(PackageDestination, {
  foreignKey: 'package_id',
  as: 'destinations',
  onDelete: 'CASCADE'
});

Package.hasMany(VideoReview, {
  foreignKey: 'package_id',
  as: 'videoReviews',
  onDelete: 'SET NULL'
});

VideoReview.belongsTo(Package, {
  foreignKey: 'package_id',
  as: 'package'
});
...
CustomTrip.hasMany(Review, {
  foreignKey: 'custom_trip_id',
  as: 'reviews',
  onDelete: 'CASCADE'
});

Review.belongsTo(CustomTrip, {
  foreignKey: 'custom_trip_id',
  as: 'custom_booking'
});

TripInquiry.hasMany(Review, {
  foreignKey: 'trip_inquiry_id',
  as: 'reviews',
  onDelete: 'CASCADE'
});

Review.belongsTo(TripInquiry, {
  foreignKey: 'trip_inquiry_id',
  as: 'custom_package'
});
...
Pipeline.hasMany(LeadFormField, {
  foreignKey: 'pipeline_id',
  as: 'formFields',
  onDelete: 'CASCADE'
});

LeadFormField.belongsTo(Pipeline, {
  foreignKey: 'pipeline_id',
  as: 'pipeline'
});
...
PackageDestination.belongsTo(Package, {
  foreignKey: 'package_id',
  as: 'package'
});

PackageDestination.belongsTo(Destination, {
  foreignKey: 'destination_id',
  as: 'destination'
});
...
PackageDestination.hasMany(PackageDay, {
  foreignKey: 'package_destination_id',
  as: 'days',
  onDelete: 'CASCADE'
});

PackageDay.belongsTo(PackageDestination, {
  foreignKey: 'package_destination_id',
  as: 'packageDestination'
});

PackageDay.hasMany(PackageActivity, {
  foreignKey: 'package_day_id',
  as: 'activities',
  onDelete: 'CASCADE'
});

PackageActivity.belongsTo(PackageDay, {
  foreignKey: 'package_day_id',
  as: 'packageDay'
});
...
Media.belongsTo(Destination, {
  foreignKey: 'entity_id',
  constraints: false,
  as: 'destination'
});

Destination.hasMany(DestinationTax, {
  foreignKey: 'destination_id',
  as: 'taxes',
  onDelete: 'CASCADE'
});

DestinationTax.belongsTo(Destination, {
  foreignKey: 'destination_id',
  as: 'destination'
});
...
PackageInclusion.belongsTo(Package, {
  foreignKey: 'package_id',
  as: 'package'
});

PackageExclusion.belongsTo(Package, {
  foreignKey: 'package_id',
  as: 'package'
});

PackageHighlight.belongsTo(Package, {
  foreignKey: 'package_id',
  as: 'package'
});
...
Country.hasMany(ForexService, {
  foreignKey: 'country_id',
  as: 'forexServices'
});

ForexService.belongsTo(Country, {
  foreignKey: 'country_id',
  as: 'country'
});

Country.hasMany(ForexConversionRate, {
  foreignKey: 'country_id',
  as: 'forexConversionRates'
});

ForexConversionRate.belongsTo(Country, {
  foreignKey: 'country_id',
  as: 'country'
});

Customer.hasMany(ForexConversionRequest, {
  foreignKey: 'customer_id',
  as: 'forexConversionRequests',
  onDelete: 'CASCADE'
});

ForexConversionRequest.belongsTo(Customer, {
  foreignKey: 'customer_id',
  as: 'customer'
});

Lead.hasMany(ForexConversionRequest, {
  foreignKey: 'lead_id',
  as: 'forexConversionRequests',
  onDelete: 'SET NULL'
});

ForexConversionRequest.belongsTo(Lead, {
  foreignKey: 'lead_id',
  as: 'lead'
});

JournalEntry.hasMany(ForexConversionRequest, {
  foreignKey: 'journal_entry_id',
  as: 'forexConversionRequests',
  onDelete: 'SET NULL'
});

ForexConversionRequest.belongsTo(JournalEntry, {
  foreignKey: 'journal_entry_id',
  as: 'journalEntry'
});

Destination.hasMany(DestinationMapping, {
  foreignKey: 'destination_id',
  as: 'mappings'
});

DestinationMapping.belongsTo(Destination, {
  foreignKey: 'destination_id',
  as: 'destination'
});

DestinationMapping.belongsTo(City, {
  foreignKey: 'city_id',
  as: 'city'
});
...
Hotel.hasMany(HotelBooking, {
  foreignKey: 'hotel_id',
  as: 'bookings'
});

HotelBooking.belongsTo(Hotel, {
  foreignKey: 'hotel_id',
  as: 'hotel'
});

Destination.hasMany(HotelBooking, {
  foreignKey: 'destination_id',
  as: 'hotel_bookings'
});

HotelBooking.belongsTo(Destination, {
  foreignKey: 'destination_id',
  as: 'destination'
});
...
Media.belongsTo(Hotel, {
  foreignKey: 'entity_id',
  constraints: false,
  as: 'hotel'
});

Destination.hasMany(DestinationCrowdLevel, {
  foreignKey: 'destination_id',
  as: 'crowdLevels',
  onDelete: 'CASCADE'
});

DestinationCrowdLevel.belongsTo(Destination, {
  foreignKey: 'destination_id',
  as: 'destination'
});
...
Category.hasMany(PackageCategory, {
  foreignKey: 'category_id',
...
Package.hasMany(PackageBooking, {
  foreignKey: 'package_id',
  as: 'packageBookings'
});

PackageBooking.belongsTo(Package, {
  foreignKey: 'package_id',
  as: 'package'
});

User.hasMany(PackageBooking, {
  foreignKey: 'vendor_id',
  as: 'vendorPackageBookings'
});

PackageBooking.belongsTo(User, {
  foreignKey: 'vendor_id',
  as: 'vendor'
});

Customer.hasMany(PackageBooking, {
  foreignKey: 'customer_id',
  as: 'packageBookings'
});

PackageBooking.belongsTo(Customer, {
  foreignKey: 'customer_id',
  as: 'customer'
});

Coupon.hasMany(PackageBooking, {
  foreignKey: 'coupon_id',
  as: 'packageBookings'
});

PackageBooking.belongsTo(Coupon, {
  foreignKey: 'coupon_id',
  as: 'coupon'
});
...
PackageBooking.hasOne(CouponRedemption, {
  foreignKey: 'booking_id',
  as: 'couponRedemption'
});

CouponRedemption.belongsTo(PackageBooking, {
  foreignKey: 'booking_id',
  as: 'booking'
});

Customer.hasMany(CouponRedemption, {
  foreignKey: 'customer_id',
  as: 'couponRedemptions'
});

CouponRedemption.belongsTo(Customer, {
  foreignKey: 'customer_id',
  as: 'customer'
});

PackageBooking.hasMany(PackageReturnRequest, {
  foreignKey: 'booking_id',
  as: 'returnRequests',
  onDelete: 'CASCADE'
});

PackageReturnRequest.belongsTo(PackageBooking, {
  foreignKey: 'booking_id',
  as: 'booking'
});

Customer.hasMany(PackageReturnRequest, {
  foreignKey: 'customer_id',
  as: 'packageReturnRequests'
});

PackageReturnRequest.belongsTo(Customer, {
  foreignKey: 'customer_id',
  as: 'customer'
});

User.hasMany(PackageReturnRequest, {
  foreignKey: 'requested_by_user_id',
  as: 'requestedPackageReturns'
});

PackageReturnRequest.belongsTo(User, {
  foreignKey: 'requested_by_user_id',
  as: 'requestedBy'
});
...
PackageBooking.hasMany(BookingPassenger, {
  foreignKey: 'booking_id',
  as: 'passengers',
  onDelete: 'CASCADE'
});

BookingPassenger.belongsTo(PackageBooking, {
  foreignKey: 'booking_id',
  as: 'booking'
});

PackageBooking.hasMany(BookingEmailQueue, {
  foreignKey: 'booking_id',
  as: 'emailQueue',
  onDelete: 'CASCADE'
});

BookingEmailQueue.belongsTo(PackageBooking, {
  foreignKey: 'booking_id',
  as: 'booking'
});
...
Voucher.hasOne(JournalEntry, {
  foreignKey: 'voucher_id',
  as: 'journalEntry'
});

JournalEntry.belongsTo(Voucher, {
  foreignKey: 'voucher_id',
  as: 'voucher'
});
...
const {
  ...
  optionalApiAuth,
  apiKeyAuth
} = require('./middleware/apiAuthMiddleware');
...
const userRepo =
  new UserRepository(User, Role, Customer, VendorProfile);

const roleRepo =
  new RoleRepository(Role, Permission);

const permissionRepo =
  new PermissionRepository(Permission, Module);

const moduleRepo =
  new ModuleRepository(Module, Permission);

const customerRepo =
  new CustomerRepository(Customer, User);

// ===== INITIALIZE TRAVEL REPOSITORIES =====

const continentRepo =
  new ContinentRepository(Continent);

const countryRepo =
  new CountryRepository(Country, Continent);

const cityRepo =
  new CityRepository(City, Country, Continent);

const airportRepo =
  new AirportRepository(Airport);

const categoryRepo =
  new CategoryRepository(Category);

const packageCategoryRepo =
  new PackageCategoryRepository(PackageCategory, Category);
...
const couponRepo =
  new CouponRepository(Coupon, CouponRedemption);

const activityRepo =
  new ActivityRepository(Activity, Destination);

const appSettingRepo =
  new AppSettingRepository(AppSetting);

const themeRepo =
  new ThemeRepository(Theme);

const videoReviewRepo =
  new VideoReviewRepository(VideoReview, Package);
...
const forexServiceRepo =
  new ForexServiceRepository(
    ForexService,
    Country,
    Continent
  );

const forexConversionRateRepo =
  new ForexConversionRateRepository(
    ForexConversionRate,
    Country,
    Continent
  );
...
const mediaRepo =
  new MediaRepository(Media);

const pageRepo =
  new PageRepository(Page, PageDetail);

const bannerRepo =
  new BannerRepository(Banner);
...
const hotelRepo =
  new HotelRepository(Hotel);

const HotelBookingRepository =
  require('./repositories/HotelBookingRepository');

const hotelBookingRepo =
  new HotelBookingRepository(
    HotelBooking,
    Hotel,
    User,
    Customer,
...
const CustomTripRepository =
  require('./repositories/CustomTripRepository');

const customTripRepo =
  new CustomTripRepository(
    CustomTrip,
    CustomTripDay,
    CustomTripActivity,
    Hotel,
...
const TripInquiryRepository =
  require('./repositories/TripInquiryRepository');

const tripInquiryRepo =
  new TripInquiryRepository(
    TripInquiry,
    Destination,
    Customer,
    User,
...
const TripBuilderService =
  require('./services/TripBuilderService');

const tripBuilderService =
  new TripBuilderService(
    customTripRepo,
    hotelRepo,
    activityRepo,
    packageRepo
...
const userService =
  new UserService(userRepo, roleRepo);

const authService =
  new AuthService(userRepo, roleRepo, customerRepo);

const roleService =
  new RoleService(roleRepo, permissionRepo);

const moduleService =
  new ModuleService(moduleRepo);
...
const accountingService =
  new AccountingService(accountingRepo);
...
const bookingEmailScheduler =
  new BookingEmailScheduler(
    bookingEmailService
  );

// ===== TRIPJACK INITIALIZATION =====

const tripJackConfigService =
  new TripJackConfigService(ProviderConfig);

const tripJackClient =
  new TripJackClient(tripJackConfigService);
...
const tripJackCityRegionSyncService =
  new TripJackCityRegionSyncService(
    tripJackClient,
    TripJackCityRegion
  );

const tripJackContentService =
  new TripJackContentService(
    tripJackClient,
    TripJackCityRegion
  );

const tripJackContentController =
  new TripJackContentController(
    tripJackContentService,
...
const crmCustomerController =
  new CrmCustomerController(userService);

const authController =
  new AuthController(authService);

const apiCustomerController =
  new ApiCustomerController(
    authService,
    customerService,
    leadRepo
  );
...
const apiBlogController =
  new ApiBlogController(blogRepo);

const mediaController =
  new MediaController(mediaRepo);
...
const packageCategoryController =
...
const vendorDashboardController =
  new VendorDashboardController(
    vendorService,
    walletService
  );

const vendorPackageController =
  new VendorPackageController(
    vendorService,
    packageRepo,
    destinationRepo,
    categoryRepo,
...
const vendorWalletController =
  new VendorWalletController(walletService);

const accountingController =
  new AccountingController(accountingService);

const apiPackageBookingController =
  new ApiPackageBookingController(
    {
      Package,
      PackageBooking,
      BookingPassenger,
      BookingEmailQueue,
      PackageReturnRequest,
      Customer,
      User,
      Role,
      CancellationRule,
...
const adminWalletController =
  new AdminWalletController(walletService);
...
const AdminProviderController =
  require('./controllers/AdminProviderController');

const adminProviderController =
  new AdminProviderController({
    ProviderConfig
  });
...
const AdminTripBuilderController =
  require('./controllers/AdminTripBuilderController');

const adminTripBuilderController =
  new AdminTripBuilderController(
    tripBuilderService,
    hotelRepo,
    activityRepo,
    bookingRepo,
...
const TravelHotelController =
  require('./controllers/TravelHotelController');

const travelHotelController =
  new TravelHotelController(
    Hotel,
    Destination
  );

const TravelActivityController =
  require('./controllers/TravelActivityController');

const travelActivityController =
  new TravelActivityController(
    Activity,
    Destination
  );

const ApiAirportController =
  require('./controllers/ApiAirportController');

const apiAirportController =
  new ApiAirportController(airportRepo);

const ApiTripInquiryController =
  require('./controllers/ApiTripInquiryController');

const apiTripInquiryController =
  new ApiTripInquiryController(
    tripInquiryRepo,
    leadRepo,
    pipelineRepo
  );

const ApiHotelBookingController =
  require('./controllers/ApiHotelBookingController');

const apiHotelBookingController =
  new ApiHotelBookingController(
    hotelBookingRepo,
    leadRepo,
    pipelineRepo
  );
...
module.exports = {
  ...
  controllers: {
    ...
    adminTripBuilderController,
    adminProviderController,

    travelHotelController,
    travelActivityController,
    apiAirportController,
    apiTripInquiryController,
    apiHotelBookingController,
